...
Usage:
    python scripts/develop.py                           # dry-run
    python scripts/develop.py --apply                   # write files
    python scripts/develop.py --layer api,db            # specific layers
    python scripts/develop.py --plan-only               # just show what would be generated
"""
