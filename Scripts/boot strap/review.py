...
Usage:
    python scripts/review.py                           # review all
    python scripts/review.py --layer api,db            # specific layers
    python scripts/review.py --file backend/api/main.py
    python scripts/review.py --skip-consolidation
"""
